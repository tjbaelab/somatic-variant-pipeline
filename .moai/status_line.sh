...
if [ -f "/Users/taejeong/go/bin/moai" ]; then
	exec "/Users/taejeong/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/taejeong/.local/bin/moai" ]; then
	exec "/Users/taejeong/.local/bin/moai" statusline < "$temp_file"
fi
